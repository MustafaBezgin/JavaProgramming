...
public class GradeReport {
    ...
    public static void main(String[] args) {
        ...
        if (score >= 0 && score <= 100) { // if the score is valid (0 ~ 100 )
            ...
            } else if (score >= 80) { // false: score < 80  // ilk if condition zaten false çıktığı için bir daha "&& score < 90" demiyoruz.
                System.out.println("Great");
            } else if (score >= 70) { // false: score < 70  // bir üstteki else if condition zaten false çıktığı için bir daha "&& score < 80" demiyoruz.
