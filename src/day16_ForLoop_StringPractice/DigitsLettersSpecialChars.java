package day16_ForLoop_StringPractice;
...
public class DigitsLettersSpecialChars {
    ...
    public static void main(String[] args) {
        ...
        String str = "ABCDE12345678900000) (*&^%$#@!CydeoSchool";
        ...
        for (int i = 0; i < str.length(); i++) { //i: index numbers of str (0 ~ last index)
            ...
            if(ch >= '0' && ch <= '9'){ //if the character is between '0' to '9' then it's digit
                digits += ch;
            }else if((ch >= 'A' && ch <= 'Z') || (ch >= 'a' && ch <= 'z')){ // if the character is between 'A' to 'Z' then it's letter
                letters += ch;
