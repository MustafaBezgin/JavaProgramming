...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        offer1.setInfo("VA", "Amazon Inc", "SDET", 90000, true, true, true, true);
        ...
        offer4.setInfo("TX", "CapitalOne", "SM", 85000, false, false, true, true);
        ...
        for (Offer eachOffer : myOffers) {
            if (eachOffer.hasBenefit == true && eachOffer.hasPTO == true) {
                offerWithBenefits.add(eachOffer);
            }
        }
